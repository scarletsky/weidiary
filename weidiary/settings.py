# Django settings for weidiary project.
import os
import sae.const
...
SECRET_KEY = 'er4@)2f8-_8r-r*w@_2s&amp;=s*gn==32_)^ir*^z35-_!z=nv&amp;=r'
...
ROOT_URLCONF = 'weidiary.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'weidiary.wsgi.application'
